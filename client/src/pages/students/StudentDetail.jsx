    ...
    <div className="max-w-3xl mx-auto">
      <div className="flex items-center gap-3 mb-6">
        ...
        <button onClick={() => navigate(`/students/${id}/edit`)}
          className="ml-auto bg-yellow-500 text-white px-4 py-2 rounded-lg text-sm hover:bg-yellow-600">Edit</button>
      </div>
        ...
        {student.marksheet && (
          <div className="mt-4">
            <a href={student.marksheet} target="_blank"
              className="inline-flex items-center gap-2 bg-blue-50 text-blue-600 px-4 py-2 rounded-lg text-sm hover:bg-blue-100">
              📄 View Marksheet
            </a>
          </div>
        )}
